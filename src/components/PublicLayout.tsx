import { Clapperboard, HardDriveDownload, LogIn, Moon, ShieldCheck, Sun, UserRound } from 'lucide-react'
...
export function PublicLayout() {
  ...
  return <div className="site-shell">
    <header className="topbar"><div className="container topbar-inner">
      ...
      <nav className="main-nav"><NavLink to="/" end>Início</NavLink><NavLink to="/explorar">Explorar</NavLink><NavLink to="/links">Links</NavLink><NavLink to="/entretenimento"><Clapperboard size={14} style={{ verticalAlign: '-2px', marginRight: 5 }} />Entretenimento</NavLink></nav>
    ...
    </div><nav className="mobile-nav"><NavLink to="/" end>Início</NavLink><NavLink to="/explorar">Explorar</NavLink><NavLink to="/links">Links</NavLink><NavLink to="/entretenimento">Entretenimento</NavLink>{user && <NavLink to="/downloads">Downloads</NavLink>}</nav></header>
    <Outlet />
